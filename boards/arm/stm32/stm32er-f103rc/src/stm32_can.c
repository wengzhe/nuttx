/****************************************************************************
 * boards/arm/stm32/stm32er-f103rc/src/stm32_can.c
 *
...
int stm32_can_setup(void)
{
  ...
  can = stm32_caninitialize(CAN1_PORT);
  if (can == NULL)
    {
  ...
  can = stm32_caninitialize(CAN2_PORT);
  if (can == NULL)
    {
  ...
  if (ret < 0)
    {
      canerr("ERROR: can_register /dev/can1 failed: %d\n", ret);
      return ret;
    }
#endif
