/****************************************************************************
 * boards/arm/stm32/doublecan/include/board.h
 *
...
#ifndef __BOARDS_ARM_STM32_DOUBLECAN_INCLUDE_BOARD_H
#define __BOARDS_ARM_STM32_DOUBLECAN_INCLUDE_BOARD_H
...
#define BUTTON_S1_BIT  (0)
#define BUTTON_S1_MASK (1<<BUTTON_S1_BIT)
...
#define BOARD_LED1                0
#define BOARD_LED_RED0            BOARD_LED1
#define BOARD_LED2                1
#define BOARD_LED_GREEN0          BOARD_LED2
#define BOARD_LED3                2
#define BOARD_LED_RED1            BOARD_LED3
#define BOARD_LED4                3
#define BOARD_LED_GREEN1          BOARD_LED4
#define BOARD_NLEDS               4

/* LED bits for use with board_userled_all() */

#define BOARD_LED_RED0_BIT      (1 << BOARD_LED_RED0)
#define BOARD_LED_GREEN0_BIT    (1 << BOARD_LED_GREEN0)
#define BOARD_LED_RED1_BIT      (1 << BOARD_LED_RED1)
#define BOARD_LED_GREEN1_BIT    (1 << BOARD_LED_GREEN1)
...
#define GPIO_CAN2_RX         GPIO_CAN2_RX_0                                    /* PB12 */
#define GPIO_CAN2_TX         GPIO_ADJUST_MODE(GPIO_CAN2_TX_0, GPIO_MODE_50MHz) /* PB13 */

#endif /* __BOARDS_ARM_STM32_DOUBLECAN_INCLUDE_BOARD_H */
