/****************************************************************************
 * boards/arm/stm32/doublecan/src/doublecan.h
 *
...
#ifndef __BOARDS_ARM_STM32_DOUBLECAN_SRC_DOUBLECAN_H
#define __BOARDS_ARM_STM32_DOUBLECAN_SRC_DOUBLECAN_H
...
#define GPIO_LED1       (GPIO_OUTPUT | GPIO_CNF_OUTPP | GPIO_MODE_50MHz | \
                         GPIO_PORTC | GPIO_PIN0 | GPIO_OUTPUT_CLEAR)
#define GPIO_LED_RED0   GPIO_LED1
#define GPIO_LED2       (GPIO_OUTPUT | GPIO_CNF_OUTPP | GPIO_MODE_50MHz | \
                         GPIO_PORTC | GPIO_PIN1 | GPIO_OUTPUT_CLEAR)
#define GPIO_LED_GREEN0 GPIO_LED2
#define GPIO_LED3       (GPIO_OUTPUT | GPIO_CNF_OUTPP | GPIO_MODE_50MHz | \
                         GPIO_PORTC | GPIO_PIN14 | GPIO_OUTPUT_CLEAR)
#define GPIO_LED_RED1   GPIO_LED3
#define GPIO_LED4       (GPIO_OUTPUT | GPIO_CNF_OUTPP | GPIO_MODE_50MHz | \
                         GPIO_PORTC | GPIO_PIN15 | GPIO_OUTPUT_CLEAR)
#define GPIO_LED_GREEN1 GPIO_LED4
...
#define BUTTON_S1       (GPIO_INPUT | GPIO_CNF_INFLOAT | GPIO_PORTC | GPIO_PIN2 | \
                         GPIO_EXTI)
#define IRQBUTTON       BUTTON_S1_BIT
